...
import tqdm
import pickle
from utils import face_reader, take_random_image_in_folder, clear_non_image
import math
...
def detect_face(data_path, save_path):
    faces_folder = save_path/"faces"
...
if __name__ == "__main__":
    ...
    inter_pair_path = save_path/"inter_pair.pkl"
    # detect_face(data_path, save_path)
    # all_inter_pairs =  create_random_inter_pair(img_folder, num_pair=100000)

    all_inter_pairs = create_sequence_inter_pair(img_folder, 100000)

    print(len(all_inter_pairs))
